...
namespace Lab2_IT_2024.Controllers
{
    public class EventController : Controller
    {
        private static List<EventModel> events = new List<EventModel>
        {
            new EventModel(){Id = 1, Name = "Завршено средно образование", Location = "Македонија"},
            new EventModel(){Id = 2, Name = "Запросување", Location = "Албанија"},
            new EventModel(){Id = 3, Name = "Започната работа во компанија", Location = "Германија"}
        };
        // GET: Event
